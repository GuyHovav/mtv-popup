 ...
 */
export async function callOpenAI({ title, author, durationSeconds, factCount, geniusContext, wikiContext }) {
    ...
    try {
      response = await client.chat.completions.create({
        ...
        messages: [
          ...
          { role: 'user', content: buildUserPrompt({ title, author, durationSeconds, factCount, geniusContext, wikiContext }) },
        ],
